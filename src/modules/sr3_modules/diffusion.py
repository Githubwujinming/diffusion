...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        self.denoise_fn = instantiate_from_config(denoise_config)
    ...
    #     self.denoise_fn.load_state_dict(torch.load(
    #             path), strict=True)
    ...
    def feats(self, x, t, noise=None):
        ...
        fd = self.denoise_fn(x_noisy, continuous_sqrt_alpha_cumprod, feat_need=True)
